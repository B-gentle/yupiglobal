...
const ProductTemplate = ({ img, price, rating, productName, description, discount, id }) => {
  return (
    <div className='flex items-center gap-[2rem] h-[230px] border-full mb-[3rem] ml-[1rem]'>
      <div className='w-[210px] h-[210px] px-[12px] py-[13px] flex justify-center items-center'>
      ...
      <div className='flex flex-col gap-1'>
        ...
        <Rating value={rating} />
        <span className='text-[#505050] font-[400]'>{description.split(0, 10)}</span>
